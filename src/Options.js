...
export {
  errorsText, root, placeContainer, apiOptions, optionsCardList, optionsPopupImage, optionsPopupCard, optionsPopupAvatar, optionsPopupProfile, newForm, profileForm, avatarForm,
};
